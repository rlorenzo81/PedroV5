...
@Autonomous(name = "Red Back V18 Track", group = "Examples")
public class RedBackV18Track extends OpMode {
    ...
    double target = 1130.0; // change if needed

    // ================= TURRET =================
    private final TurretTracker turret = new TurretTracker();
    private double lastLoopTime = 0;
    private boolean scorePoseTurretSaved = false;
    ...
    private static final double SHOOTER_KP = 300.00;
    ...
    private static final double SHOOT_FEED_SEC = 1.3; //was 1.0

    // ================= SHOOTER SPIN-UP DELAY =================
    // ONLY used for FIRST shot window now
    private static final double SHOOTER_SPINUP_SEC = 1.5; //was 2.0

    // ================= QUICK SETTLE FOR SUBSEQUENT SHOTS =================
    private static final double SHOOT_SETTLE_SEC = 0.75; //was 0.7

    // ================= FIRST-SPINUP DONE FLAG =================
    private boolean firstSpinupDone = false;

    // ================= SHOOT FEED PULSE (REQUESTED) =================
    private static final double FEED_ON_SEC  = 1.0;
    private static final double FEED_OFF_SEC = 0.;
    ...
    private final Pose scorePose = new Pose(100, 80, Math.toRadians(41));// was 45, 84 done angle was 42
    ...
    private final Pose line1PressGate = new Pose(132, 75, Math.toRadians(0)); //done
    private final Pose driveToShoot2 = new Pose(100, 80, Math.toRadians(41)); // was 93,93 (97) done.
    ...
    private final Pose driveToShoot3= new Pose(100, 80, Math.toRadians(41)); // was 107, 97, 40.5
    private final Pose driveTowardsGate1= new Pose(117, 55, Math.toRadians(25)); // was 95 done

    private final Pose driveToGate1= new Pose(137, 58, Math.toRadians(25)); // y was 62

    private final Pose intakeFromGate1 = new Pose(142, 52.5, Math.toRadians(75)); //y was 54, angle was 105 done  x was 141 and y 51

    private final Pose driveToShoot4= new Pose(100, 80, Math.toRadians(41)); // angle was 41

    private final Pose driveTowardsGate2= new Pose(125, 55, Math.toRadians(25)); // was 95 done

    private final Pose driveToGate2= new Pose(137, 58, Math.toRadians(25)); // was 2,71 done

    private final Pose intakeFromGate2 = new Pose(141, 52.5, Math.toRadians(75)); //angle was 105 done was 52 for y

    // (kept but unused in this flow)
    private final Pose driveToShoot5 = new Pose(100, 80, Math.toRadians(41)); // was 93,93
