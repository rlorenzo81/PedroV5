...
@Autonomous(name = "BlueFront17", group = "Examples")
public class BlueFrontV17 extends OpMode {
    ...
    private static final double SHOOTER_TARGET_TPS = 1470; //shooter speed (CHANGE THIS) was 1490
    ...
    private final Pose driveTowardsCorner1= new Pose(30, 14, Math.toRadians(160)); //116

    // ===== ADDED POSES (per your request) =====
    private final Pose cornerPickUp1 = new Pose(18, 15, Math.toRadians(180));
    private final Pose driveToShoot4 = new Pose(60, 14, Math.toRadians(109));

    private final Pose driveTowardsCorner2= new Pose(30, 14, Math.toRadians(160)); //116
    private final Pose cornerPickUp2 = new Pose(20, 15, Math.toRadians(180));
    ...
    public void buildPaths() {
        ...
        goCorner1 = follower.pathBuilder()
                .addPath(new BezierLine(driveToShoot2, driveTowardsCorner1))
                .setLinearHeadingInterpolation(driveToShoot2.getHeading(), driveTowardsCorner1.getHeading())
                .addPath(new BezierLine(driveTowardsCorner1, cornerPickUp1))
                .setLinearHeadingInterpolation(driveTowardsCorner1.getHeading(), cornerPickUp1.getHeading())
                .build();
        ...
        goCorner2 = follower.pathBuilder()
                .addPath(new BezierLine(driveToShoot4, driveTowardsCorner2))
                .setLinearHeadingInterpolation(driveToShoot4.getHeading(), driveTowardsCorner2.getHeading())
                .addPath(new BezierLine(driveTowardsCorner2, cornerPickUp2))
                .setLinearHeadingInterpolation(driveTowardsCorner2.getHeading(), cornerPickUp2.getHeading())
                .build();
    ...
    public static class TurretTracker {
        ...
        private static final double VALID_ACQUIRE_SEC = 0.08;
        private static final double INVALID_LOSS_SEC = 0.12;
        private static final double VISION_RAMP_SEC = 0.12;

        private static final int REACQUIRE_IGNORE_FRAMES = 1;
        private static final double REACQUIRE_MODE_SEC = 0.20;
        private static final double REACQUIRE_GAIN_SCALE = 0.60;
        private static final double REACQUIRE_NO_MOVE_TX = 0.60;

        // ===== OFFSET ADDED =====
        // Tune this to intentionally hold a little off the AprilTag center.
        // Start with small values like +/-1.0 to +/-3.0.
        private static final double TX_AIM_OFFSET = 1;
