...
public class RedBackV17 extends OpMode {
    ...
    double target = 1130.0; // change if needed was 1150 working good but some bounce out, this is the speed it shoots was 1135
    ...
    private static final int TURRET_OFFSET_TICKS = 130; // adjust this number was 100
    ...
    private static final double SHOOT_SETTLE_SEC = 0.9; //changed was 0.5
