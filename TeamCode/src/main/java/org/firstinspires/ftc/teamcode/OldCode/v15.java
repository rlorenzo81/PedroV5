...
@Autonomous(name = "BF Last Nerve", group = "Examples")
@Disabled
public class v15 extends OpMode {
    ...
    public static class TurretTracker {
        ...
        private static final double FF = 0.000; //was 0.012
        private static final double LEAD_TIME = 0.00;  //was 0.03
        ...
        private static final double TURRET_AIM_OFFSET_DEG = 1; // was -0.5

        private static final int LOST_TARGET_OFFSET_TICKS = -300;
        ...
        public void lockCurrentPosition() {
            savedTicks = turret.getCurrentPosition();
        ...
        public void update(double now, double dt, double moveBlend, double omegaDps) {
            ...
            if (r == null || !r.isValid()) {
                if (hasSavedPosition) {
                    double errorTicks = (savedTicks + LOST_TARGET_OFFSET_TICKS) - turret.getCurrentPosition();
