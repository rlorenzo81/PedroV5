...
@Autonomous(name = "Blue Back V17", group = "Examples")
public class BlueBackV17 extends OpMode {
    ...
    private final Pose line2ToShoot3Mid = new Pose(15, 55, Math.toRadians(127));
