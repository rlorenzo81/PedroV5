...
@Autonomous(name = "Blue Front V9", group = "Examples")
public class BlueFrontV9 extends OpMode {
    ...
    private static final double SHOOTER_TARGET_TPS = 1600; //shooter speed (CHANGE THIS) was 1445
    ...
    private final Pose driveToShoot2 = new Pose(60, 20, Math.toRadians(114.05));
    private final Pose toArtifactLine2 = new Pose(44, 56, Math.toRadians(180));
    private final Pose driveThroughLine2 = new Pose(11, 56, Math.toRadians(180));
    private final Pose driveToShoot3 = new Pose(60, 21, Math.toRadians(114)); //116
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 3:
                if (!follower.isBusy()) {
                    intakeHolds();
                    follower.followPath(goShoot2, 0.7, true);
                    setPathState(4);
                }
                break;
            ...
            case 6:
                if (!follower.isBusy()) {
                    intakeHolds();
                    follower.followPath(goShoot3, 0.7, true);
                    setPathState(7);
                }
                break;
