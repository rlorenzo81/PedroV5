...
@TeleOp(name="RC RED No Pulse", group="Robot")
@Disabled
public class RCREDNoPulse extends OpMode {
    ...
    private static final double TURRET_KP_TURNING  = 0.028;  // keep was 0.025
    ...
    // Slow / straight
    private static final double MAX_TURRET_POWER_SLOW = 0.5; //was 0.4
    ...
    private static final double SHOOTER_VEL_KP = 300.0;
    ...
    public void loop() {
        ...
        // LB2: toggle slow
        // RB2: HOLD (NO PULSE) -> fi/bi = 1.0 while held
        // B2 : OFF
        // =========================
        ...
        if (b2Now) {
            ...
            // Enter/maintain HOLD mode while RB2 is held
            if (rb2JustPressed) {
        ...
        // =========================
        // FEED APPLY
        // - RB2 HELD: NO PULSE, just fi/bi = 1.0 while held
        ...
        if (reverseHeld) {
            ...
            // RB2 HELD: NO PULSE (run both motors at 1.0)
            rbHoldPulseOn = true;
            fi.setPower(1.0);
            bi.setPower(1.0);
