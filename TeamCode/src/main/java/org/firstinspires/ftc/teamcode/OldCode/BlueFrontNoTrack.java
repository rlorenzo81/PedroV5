...
@Autonomous(name = "Blue Front NoTrack", group = "Examples")
@Disabled
public class BlueFrontNoTrack extends OpMode {
    ...
    private final Pose driveToShoot2 = new Pose(60, 14, Math.toRadians(112));
    ...
    private final Pose driveToShoot3 = new Pose(60, 14, Math.toRadians(112)); //116

    // ===== ADDED POSES (per your request) =====
    private final Pose cornerPickUp1 = new Pose(10, 20, Math.toRadians(225));
    private final Pose driveToShoot4 = new Pose(61, 14, Math.toRadians(109));
    private final Pose cornerPickUp2 = new Pose(10, 20, Math.toRadians(225));
    private final Pose driveToShoot5 = new Pose(60, 14, Math.toRadians(112));
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 1:
                ...
                if (!follower.isBusy()) {
                    if (runShootWindowFirst()) {
                        intakeSlow();
                        follower.followPath(driveToLine1, 0.5,true);
                        setPathState(2);
                    }
                }
                break;
            ...
            case 2:
                if (!follower.isBusy()) {
                    intakeSlow();
                    follower.followPath(pickUpLine1,0.5, true);
                    setPathState(3);
                }
                break;
            ...
            case 4:
                ...
                if (!follower.isBusy()) {
                    if (runShootWindowQuick()) {
                        intakeSlow();
                        follower.followPath(goCorner1, 0.5,true);
                        setPathState(8);
                    }
                }
                break;
            ...
            case 8:
                ...
                if (!follower.isBusy()) {
                    intakeHolds();
                    follower.followPath(goShoot4, 0.5, true);
                    setPathState(9);
                }
                break;
            ...
            case 9:
                ...
                if (!follower.isBusy()) {
                    if (runShootWindowQuick()) {
                        intakeSlow();
                        follower.followPath(goCorner2, 0.5,true);
                        setPathState(10);
                    }
                }
                break;
            ...
            case 10:
                ...
                if (!follower.isBusy()) {
                    intakeHolds();
                    follower.followPath(goShoot5, 0.5, true);
                    setPathState(11);
                }
                break;
            ...
            case 11:
                ...
                if (!follower.isBusy()) {
                    if (runShootWindowQuick()) {
                        intakeStop();
                        follower.followPath(leaveOutChain,0.5, true);
                        setPathState(12);
                    }
                }
                break;
    ...
    public void loop() {
        ...
        // Turret: NO TRACKING (hold wherever it is)
        if (turretSpin != null) turretSpin.setPower(0.0);
