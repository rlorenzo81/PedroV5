...
@Autonomous(name = "Red Back V7 Line1", group = "Examples")
@Disabled
public class RedBackV7WithLine1 extends OpMode {
    ...
    // ====== NEW (requested) ======
    private final Pose toArtifactLine1 = new Pose(100, 84, Math.toRadians(0));
    private final Pose driveThroughLine1 = new Pose(130, 84, Math.toRadians(0));
