...
@Autonomous(name = "RedFrontV16", group = "Examples")
public class RedFrontV16 extends OpMode {
    ...
    private final Pose cornerPickUp1 = new Pose(130, 20, Math.toRadians(315));     // TODO: tune
    private final Pose driveToShoot4 = new Pose(84, 22, Math.toRadians(65));      // TODO: tune (often same as shoot poses)
    private final Pose cornerPickUp2 = new Pose(132, 20, Math.toRadians(315));     // TODO: tune
    ...
    public static class TurretTracker {
        ...
        public void saveReturnPosition() {
            if (!hasSavedReturnPosition) {
                savedReturnPosition = turret.getCurrentPosition();
