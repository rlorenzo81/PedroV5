...
@Autonomous(name = "Blue Front Cycle", group = "Examples")
public class BlueFrontV10CycleCorner extends OpMode {
    ...
    private final Pose driveToShoot4 = new Pose(61, 14, Math.toRadians(112));
