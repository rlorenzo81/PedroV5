...
public class BlueBackStock extends OpMode {
    ...
    // posepose
    private final Pose startPose = new Pose(12, 132, Math.toRadians(135));
    private final Pose scorePose = new Pose(46, 98, Math.toRadians(135));
    private final Pose toArtifactLine1 = new Pose(33, 91, Math.toRadians(180));
    private final Pose driveThroughLine1 = new Pose(3.5, 91, Math.toRadians(180));
    private final Pose driveToShoot2 = new Pose(45, 95, Math.toRadians(138));
    private final Pose toArtifactLine2 = new Pose(31, 66, Math.toRadians(180));
    private final Pose driveThroughLine2 = new Pose(0, 66, Math.toRadians(180));
    private final Pose driveToShoot3 = new Pose(45, 95, Math.toRadians(138));
    private final Pose leavePose = new Pose(31, 66, Math.toRadians(180));
