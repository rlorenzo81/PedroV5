...
@Autonomous(name = "Red Back V2 FastShot", group = "Examples")
public class RedBackV2FastShot extends OpMode {
    ...
    private final Pose driveToShoot3 = new Pose(93, 77, Math.toRadians(0)); // was 53
