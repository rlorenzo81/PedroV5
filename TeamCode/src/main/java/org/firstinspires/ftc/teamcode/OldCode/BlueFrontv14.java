...
@Autonomous(name = "Blue Front Please Work", group = "Examples")
@Disabled
public class BlueFrontv14 extends OpMode {
    ...
    public static class TurretTracker {
        ...
        private static final double TURRET_AIM_OFFSET_DEG = 0; // was -0.5
        ...
        public void update(double now, double dt, double moveBlend, double omegaDps) {
            ...
            if (r == null || !r.isValid()) {
                if (hasSavedPosition) {
                    double errorTicks = savedTicks - turret.getCurrentPosition();
