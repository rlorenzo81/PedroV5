...
@Autonomous(name = "Red Back 3-13", group = "Examples")
@Disabled
public class RedBackV9 extends OpMode {
    ...
    private final Pose driveToShoot4= new Pose(100, 82, Math.toRadians(47)); // angle was 41
    ...
    private final Pose driveToShoot5 = new Pose(100, 82, Math.toRadians(48)); // was 93,93
    ...
    public static class TurretTracker {
        ...
        private static final double RETURN_MAX_PWR = 0.65;
